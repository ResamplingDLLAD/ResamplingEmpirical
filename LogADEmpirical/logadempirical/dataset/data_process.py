...
def process_dataset(data_dir, output_dir, log_file, dataset_name, window_type, window_size, step_size, train_size,
    ...
    if window_type == "sliding":
        ...
        if dataset_name == "hdfs":
            ...
            train_window = window_df[:n_train]
            test_window = window_df[n_train:]
        print('There are %d instances (sliding windows) in training set' % len(train_window))
        print('There are %d instances (sliding windows) in test set' % len(test_window))
    else:
    ...
    print(f'\nSave processed dataset to {output_dir}')
...
if __name__ == '__main__':
    process_dataset(data_dir="../../dataset/bgl/", output_dir="../../dataset/bgl/", log_file="BGL.log", dataset_name="bgl",
